...
public class SampleDownloaderActivity extends AppCompatActivity implements IDownloaderClient, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private void initializeDownloadUI() {
        ...
        setContentView(R.layout.sample_downloader_activity);
    ...
    private void startVideoPlayerActivity() {
        Intent intent = new Intent(SampleDownloaderActivity.this, MainActivity.class);
